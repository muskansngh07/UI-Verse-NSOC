# Contributor Covenant Code of Conduct — UI-Verse NSoC'26
...
This Code of Conduct is adapted from the [Contributor Covenant (v3.0)](https://www.contributor-covenant.org/version/3/0/code_of_conduct/), with modifications tailored for **UI-Verse under the Nexus Spring of Code (NSoC’26)**.  
...
Let’s make **UI-Verse** a place where everyone feels welcome to **learn, contribute, and innovate.** 🍰🤖💡 
